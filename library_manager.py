...
/* Mobile-specific styles for View Library */
@media (max-width: 640px) {
    ...
    .library-view .book-card h3,
    .library-view .book-card p {
        color: #FFFFFF;
    }
    .library-view .success-message,
    .library-view .warning-message {
        color: #1F2937;
    }
    .main-header {
...
# --- Library View ---
    ...
    st.markdown("<div class='library-view'>", unsafe_allow_html=True)
